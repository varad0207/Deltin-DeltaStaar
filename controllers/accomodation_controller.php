...
<?php 
    ...
    if (isset($_POST['update'])) {
        ...
        mysqli_query($conn, "UPDATE accomodation SET acc_name='$acc_name',bldg_status='$bldg_status',location='$location',gender='$gender',tot_capacity='$tot_capacity',no_of_rooms='$no_of_rooms',occupied_rooms='$occupied_rooms',available_rooms='$available_rooms',owner='$owner',remark='$remark' WHERE acc_code='$acc_code'");
