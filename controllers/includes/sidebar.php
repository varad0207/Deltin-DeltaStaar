            ...
            <?php if ($rights['rights_complaints'] > 0 || $rights['rights_jobs'] > 0) { ?>
                <li class="nav-item has-submenu">
                    ...
                    <ul class="submenu collapse">
                        ...
                        <?php if ($isSecurity) : ?>
                            <li>
                                <a class="nav-link border-dark border-bottom" href="../<?php echo $link; ?>views/complaint/security_jobs.php">
                                    View Jobs
                                </a>
                            </li>
                        ...
                        <?php if ($_SESSION['is_superadmin']) { ?>
                            <!-- 
                    <li>
                        <a class="nav-link border-dark border-bottom" href="../<?php //echo $link; 
                                                                                ?>views/config/complaint_type.php">
                            Add Complaint Type
                        </a>
                    </li> -->
                            <li>
