...
if (isset($_POST['submit']) && !empty($_POST['submit'])) {
    ...
    $insert = "insert into rooms(acc_id,security_emp_id,tanker_id,location,quality_check,qty, bill_no,vendor_name) values ('$acc_id','$emp_id','tanker_id','$location','quality_check','qty', 'bill_no','vendor_name')";
    */
