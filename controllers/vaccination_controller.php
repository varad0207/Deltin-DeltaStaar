...
if (isset($_POST['submit'])) {
    ...
    mysqli_query($conn,"insert into change_tracking_vaccination (user,type,vaccination_id,emp_id,emp_code,category_id,date_of_administration,location,date_of_next_dose) VALUES ('{$_SESSION['user']}','Insert','$last_insert_id','$emp_id','{$emp_row['emp_code']}','$category','$dateofadministration','$location','$nextdose')");
...
if (isset($_POST['update'])) {
    ...
    $location=$_POST['loc'];
    // echo $location;
    mysqli_query($conn, "INSERT INTO vaccination(emp_id,emp_code,category_id,date_of_administration,location,date_of_next_dose) VALUES ('$emp_id','$category','$dateofadministration','$location','$nextdose')");
    $last_insert_id = mysqli_insert_id($conn);
    $_SESSION['message'] = "Vaccnation Info updated!";

    //change tracking code
    if($AllowTrackingChanges)
    mysqli_query($conn,"insert into change_tracking_vaccination (user,type,vaccination_id,emp_id,emp_code,category_id,date_of_administration,location,date_of_next_dose) VALUES ('{$_SESSION['user']}','Update','$last_insert_id','$emp_id','{$emp_row['emp_code']}','$category','$dateofadministration','$location','$nextdose')");
