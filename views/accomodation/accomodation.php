	...
	<?php } ?>
          ...
          <option value="Other">Other</option>
					...
					<div class="input-group">
						...
						<input class="form-control" type="number" id="nor" name="no_of_rooms" value="<?php echo $no_of_rooms; ?>">
					</div>
						</label>
					<div class="input-group">
						<label class="d-block mb-4"> <span class="d-block mb-2">Occupied Number of Rooms <span>
						<input class="form-control" type="number" id="occnor" name="occupied_rooms" value="<?php echo $occupied_rooms; ?>">
					</div>
						</label>
					<div class="input-group">
						<label class="d-block mb-4"> <span class="d-block mb-2">Available Number of Rooms<span>
						<input class="form-control" type="number" onclick="calc()" id="avr" name="available_rooms" value="<?php echo $available_rooms; ?>">
